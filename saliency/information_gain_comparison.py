...
for i in range(0,ANZAHL,1):
    ...
    information_gain = compare.saliency_information_gain(gaze_map, saliency) # maybe tf squeeze
...
print("Average Informaiton gain: ", average_gain)
...
average_gain = av_info_gain_sum / ANZAHL
print("Average RANDOM Informaiton gain: ", average_gain)